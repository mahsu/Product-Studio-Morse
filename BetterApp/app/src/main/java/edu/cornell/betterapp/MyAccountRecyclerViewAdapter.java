...
import edu.cornell.betterapp.AccountFragment.OnListFragmentInteractionListener;
import edu.cornell.betterapp.dummy.DummyContent.DummyItem;
...
public class MyAccountRecyclerViewAdapter extends RecyclerView.Adapter<MyAccountRecyclerViewAdapter.ViewHolder> {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View view) {
            super(view);
            mView = view;
            mIdView = (TextView) view.findViewById(R.id.accountName);
            mContentView = (TextView) view.findViewById(R.id.accountDetails);
        }
